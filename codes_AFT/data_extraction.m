...
nn_fun = @net_naca0012_tri_fine_ns; %net_naca0012_quadBC_c;net_naca0012_tri_fine;net_airfoil_quadBC;net_rae2822_tri;net_cylinder_tri
num_label   = 0;
...
sizeFileType = 0;
%%
[AFT_stack,Coord, Grid, wallNodes]  = read_grid('../grid/inv_cylinder/tri/inv_cylinder-10.cas', gridType);
