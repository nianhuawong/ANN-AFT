...
candidateList1(end+1) = node_best + 1;  %候选点集
candidateList2(end+1) = node_best + 2;

node_tmp1 = NodeCandidate([Grid_stack;AFT_stack_sorted], node1_base, node2_base, xCoord_AFT, yCoord_AFT, [x_best1, y_best1], al * Sp ); %相交性判断时可能涉及到的点
