function DisplayResultsHybrid(nCells,nFronts,nNodes,nNewFronts,generateTime,updateTime,plotTime,tstart,flag)
global crossCount countMode_quad countMode_tri nCells_quad nCells_tri;
